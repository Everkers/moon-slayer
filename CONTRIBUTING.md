...
Make sure you read the [README.md](https://github.com/Everkers/moon-slayer/README.md).

Do not open issues for general support questions as we want to keep GitHub issues for bug reports and feature requests, you can also contact me on discord `Everkers#6416`. 

Remember that this is an inclusive community, commited to creating a safe, positive environment.
...
### Best Practices to send Pull Requests:
  - Fork the [project](https://github.com/Everkers/moon-slayer) on GitHub
  - Clone the project locally into your system.
```
git clone https://github.com/Everkers/moon-slayer.git
```
...
1. Set the `upstream`.
```
git remote add upstream https://github.com/Everkers/moon-slayer.git
```
2. Use `git remote -v` to check the status. The output must be something like this:
```
  > origin    https://github.com/Everkers/moon-slayer.git (fetch)
  > origin    https://github.com/Everkers/moon-slayer.git (push)
  > upstream  https://github.com/Everkers/moon-slayer.git (fetch)
  > upstream  https://github.com/Everkers/moon-slayer.git (push)
```
